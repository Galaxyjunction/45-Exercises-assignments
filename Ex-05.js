...
//message.
let quote = "He who believes in Allah and the last day must either speak good or remain silent.";
let famous_person = "Prophet Muhammad (S.A.W.W)";
let Message = `${quote} once said, ${famous_person}`;
console.log(Message);
